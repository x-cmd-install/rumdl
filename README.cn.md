...
[![x-cmd/install — rumdl Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/rumdl.svg?lang=zh)](https://x-cmd.com/install/rumdl)
...
合计: **356,382** 行代码（覆盖前 5 种语言、共 **702** 个文件）。
...
- **最新版本**: `v0.2.77` (2026-09-23)
- **最近提交**: 2026-09-24
- **Release 含资产**: 14 个

## 流行度

- **Star**: 1,519 · **Fork**: 88 · **开放 issue**: 741 · **贡献者**: 59

## 累计统计

- **发布数**: 389 · **已合并 PR**: 123 · **开放 PR**: 2 · **已关闭 issue**: 712 · **开放 issue**: 29 · **提交数**: 3481
...
_数据快照: `data/card/260925.yml` · 2026-09-25T04:20:06Z._
