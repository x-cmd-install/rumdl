...
![rumdl](https://repo.x-cmd.io/rumdl.svg?lang=zh)
...
合计: **344,632** 行代码（覆盖前 5 种语言、共 **690** 个文件）。
...
- **Star**: 1,503 · **Fork**: 87 · **开放 issue**: 718 · **贡献者**: 58

## 累计统计

- **发布数**: 385 · **已合并 PR**: 120 · **开放 PR**: 8 · **已关闭 issue**: 692 · **开放 issue**: 26 · **提交数**: 3428
...
_数据快照: `data/card/260917.yml` · 2026-09-17T04:21:01Z._
